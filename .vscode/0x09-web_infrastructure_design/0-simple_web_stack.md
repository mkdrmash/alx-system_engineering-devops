...
[Visit Board](https://miro.com/app/board/uXjVP6lGf4w=/?share_link_id=552207531155)
...
Domain names are a key part of the Internet infrastructure. They provide a human-readable address for any web server available on the Internet. For example, the domain name `www.google.org` is easier to recognize and remember than `108.177.16.1`. The IP address and domain name alias is mapped in the Domain Name System (DNS)
